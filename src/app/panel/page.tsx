...
import { TableSearchBar } from "@/components/panel/TableSearchBar";
import { NoTablesFound } from "@/components/panel/NoTablesFound";
                ...
                {filteredTables.map((tableInfo, index) => {
                  ...
                  return (
                    <TableCard
                      ...
                      onColumnFilterChange={(value) => handleFilterChange(tableKey, value)}
                      onDataFilterChange={(value) => handleDataFilterChange(tableKey, value)}
                      onColumnSelection={(columnName, checked) => handleColumnSelection(tableKey, columnName, checked)}
                    />
                  );
                })}
              </div>
